                    ...
                    <table class="min-w-full border border-gray-200 divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($class->name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($class->code); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo e($class->created_at); ?></td>
                                    
                                    <td class="px-6 py-4 whitespace-nowrap text-center">
                                        <a class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-gray-700 transition" href="<?php echo e(route('classes.edit', $class->id)); ?>">Edit</a>
                                        <?php if($class->status): ?>
                                        <form class="inline-block"  action="<?php echo e(route('classes.deactivate', $class->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to deactivate this class?')">
                                            <?php echo csrf_field(); ?> 
                                        ...
                                        <?php else: ?> 
                                         <form class="inline-block" action="<?php echo e(route('classes.activate', $class->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to activate this class?')">
                                            <?php echo csrf_field(); ?> 
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\student_mgt_syst-main\student_mgt_syst-main\resources\views\classes\index.blade.php ENDPATH**/ ?>