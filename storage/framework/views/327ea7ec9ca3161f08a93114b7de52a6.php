...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            <?php echo e(__('View Master Results')); ?>
...
fetch(`<?php echo e(route('student_results.getMasterResults')); ?>`, {
    method: 'POST',
    headers: {
...
.then(data => {
    ...
    results.forEach((r, index) => {
        ...
        table += `
                ...
                <form method="GET" action="<?php echo e(route('student_results.reportcard')); ?>">
...
<?php /**PATH C:\xampp\htdocs\student_mgt_syst-main\student_mgt_syst-main\resources\views/student_results/teacher/masterresult.blade.php ENDPATH**/ ?>