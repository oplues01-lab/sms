...
<body>
    ...
    <nav class="navbar fixed w-full z-50 py-4 px-6 md:px-12 flex justify-between items-center">
        ...
        <div class="nav-buttons flex space-x-4">
            <a href="<?php echo e(route('login')); ?>" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition shadow-lg">Portal</a>
...
</html><?php /**PATH C:\xampp\htdocs\student_mgt_syst-main\student_mgt_syst-main\resources\views\contact.blade.php ENDPATH**/ ?>